...
.sao-yi-sao-footer li.scan-book div {
    background-image: url(../../img/sao-yi-sao/scan-book.png);
}

.sao-yi-sao-footer li.scan-book.current div {
    background-image: url(../../img/sao-yi-sao/scan-book_hl.png);
}

.sao-yi-sao-footer li.scan-street div {
    background-image: url(../../img/sao-yi-sao/scan-street.png);
}

.sao-yi-sao-footer li.scan-street.current div {
    background-image: url(../../img/sao-yi-sao/scan-street_hl.png);
}

.sao-yi-sao-footer li.scan-word div {
    background-image: url(../../img/sao-yi-sao/scan-word.png);
}
